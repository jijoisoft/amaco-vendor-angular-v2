...
@Component({
  selector: 'app-order-card2',
  templateUrl: './order-card2.component.html',
  styleUrls: ['./order-card2.component.sass']
})
export class OrderCard2Component implements OnInit {
